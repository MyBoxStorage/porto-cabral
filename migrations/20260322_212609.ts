...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_menu_items_category" AS ENUM('entradas-quentes', 'entradas-frias', 'saladas', 'iguarias-do-mar', 'peixes', 'camaroes', 'trattoria', 'carnes-aves', 'horta-ao-prato', 'sobremesas', 'bebidas', 'drinks', 'caipirinhas', 'doses');
  ...
  ALTER TABLE "experiences" ADD CONSTRAINT "experiences_background_image_id_media_id_fk" FOREIGN KEY ("background_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "experiences_background_image_idx" ON "experiences" USING btree ("background_image_id");
